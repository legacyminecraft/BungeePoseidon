...
import com.legacyminecraft.bungeeposeidon.service.ServiceClientHttpException;
...
public final class ProfileService {
    ...
    public MinecraftProfile lookupProfileByName(String name) throws ProfileNotFoundException, ServiceClientException {
        try {
            String url = "https://api.minecraftservices.com/minecraft/profile/lookup/name/" + encode(name);
    ...
    public MinecraftProfile lookupProfileById(UUID id) throws ProfileNotFoundException, ServiceClientException {
        try {
            String url = "https://api.minecraftservices.com/minecraft/profile/lookup/" + encode(UuidUtil.toUndashedString(id));
            return this.client.get(url, MinecraftProfile.class);
        } catch (ServiceClientException e) {
